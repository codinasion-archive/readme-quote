...
If you want to add or modify any content, [search if an issue already exists](https://github.com/codinasion/readme-quote/issues). If a related issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/codinasion/readme-quote/issues/new/choose).
...
2. Clone the forked repository.
  ...
  ```
  git clone https://github.com/your_username/readme-quote
  ```
